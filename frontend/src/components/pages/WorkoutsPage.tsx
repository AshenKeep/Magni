...
export default function WorkoutsPage() {
  ...
  const [mode, setMode] = useState<ViewMode>(() => {
    ...
    // Default to day view on touch devices (week grid too cramped for fingers)
    return window.matchMedia("(pointer: coarse)").matches ? "day" : "week";
  });
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6 max-w-6xl w-full">
      {/* Header */}
